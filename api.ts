...
export const PetApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updatePetWithForm(petId: string, name?: string, status?: string, options: any = {}): FetchArgs {
            // verify required parameter 'petId' is not null or undefined
            if (petId === null || petId === undefined) {
...
export const PetApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        updatePetWithForm(petId: string, name?: string, status?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
         ...
         * @throws {RequiredError}
         */
        uploadFile(petId: number, additionalMetadata?: string, file?: Blob, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
...
export const PetApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        updatePetWithForm(petId: string, name?: string, status?: string, options?: any) {
...
export class PetApi extends BaseAPI {
     ...
     * @memberof PetApi
     */
    public updatePetWithForm(petId: string, name?: string, status?: string, options?: any) {
...
export const StoreApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrderById(orderId: string, options: any = {}): FetchArgs {
            // verify required parameter 'orderId' is not null or undefined
            if (orderId === null || orderId === undefined) {
...
export const StoreApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrderById(orderId: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Order> {
...
export const StoreApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrderById(orderId: string, options?: any) {
